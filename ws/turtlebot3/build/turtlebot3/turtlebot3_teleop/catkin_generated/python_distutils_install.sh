...
echo_and_run cd "/home/teodor/ws/turtlebot3/src/turtlebot3/turtlebot3_teleop"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/teodor/ws/turtlebot3/src/turtlebot3/turtlebot3_teleop/setup.py" \
     \
    build --build-base "/home/teodor/ws/turtlebot3/build/turtlebot3/turtlebot3_teleop" \
    install \
    --root="${DESTDIR-/}" \
