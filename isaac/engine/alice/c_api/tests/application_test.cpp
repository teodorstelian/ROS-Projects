...
TEST(CApiApplication, GetSetParam) {
  ...
  {
    error = isaac_set_parameter_from_string(app, "flatscan_generator", "generator", "beam_count", "10000");
    EXPECT_EQ(isaac_error_success, error);
  }
  {
    isaac_json_t json;
  ...
  error = isaac_set_parameter_from_string(app, "flatscan_generator", "generator", "tick_period", "\"100Hz\"");
  ASSERT_EQ(error, isaac_error_success);
  json.size = buffer.size();
  error = isaac_get_parameter(app, "flatscan_generator", "generator", "tick_period", &json);
  ASSERT_EQ(error, isaac_error_success);
  ...
  error = isaac_set_parameter_from_string(app, "flatscan_generator", "generator", "dummy1", "false");
  ASSERT_EQ(error, isaac_error_success);
  json.size = buffer.size();
  error = isaac_get_parameter(app, "flatscan_generator", "generator", "dummy1", &json);
  ASSERT_EQ(error, isaac_error_success);
  ...
  error = isaac_set_parameter_from_string(app, "flatscan_generator", "generator", "dummy2", "3.14159");
  ASSERT_EQ(error, isaac_error_success);
  json.size = buffer.size();
  error = isaac_get_parameter(app, "flatscan_generator", "generator", "dummy2", &json);
  ASSERT_EQ(error, isaac_error_success);
  ...
  error = isaac_set_parameter_from_string(app, "flatscan_generator", "generator", "dummy3", "[4,\"hi\",7]");
  ASSERT_EQ(error, isaac_error_success);
  json.size = buffer.size();
  error = isaac_get_parameter(app, "flatscan_generator", "generator", "dummy3", &json);
  ASSERT_EQ(error, isaac_error_success);
