...
TEST(PoseTree, callbackCalledOnSet) {
  ...
  isaac::alice::PoseTree::UpdateFunction callback =
      [&callbackFlag](const std::string& lhs, const std::string& rhs, double stamp,
...
TEST(PoseTree, callbackStopsOnDeregister) {
  ...
  isaac::alice::PoseTree::UpdateFunction callback =
      [](const std::string& lhs, const std::string& rhs, double stamp,
...
TEST(PoseTree, callbackReceivesCorrectParameters) {
  ...
  isaac::alice::PoseTree::UpdateFunction callback = [&pose3d](const std::string& lhs,
                                                              const std::string& rhs, double stamp,
                                                              const isaac::Pose3d& lhs_T_rhs) {
    EXPECT_EQ(lhs, "a");
    EXPECT_EQ(rhs, "b");
...
TEST(PoseTree, multipleCallbacks) {
  ...
  isaac::alice::PoseTree::UpdateFunction callbackA =
      [&callbackFlagA](const std::string& lhs, const std::string& rhs, double stamp,
                       const isaac::Pose3d& lhs_T_rhs) {
  ...
  isaac::alice::PoseTree::UpdateFunction callbackB =
      [&callbackFlagB](const std::string& lhs, const std::string& rhs, double stamp,
                       const isaac::Pose3d& lhs_T_rhs) {
