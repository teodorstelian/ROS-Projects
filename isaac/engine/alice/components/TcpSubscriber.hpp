...
class TcpSubscriber : public Codelet {
 public:
  TcpSubscriber();
  ~TcpSubscriber();
  ...
  // If a connection to the remote can not be established or breaks we try to re-establish the
...
ISAAC_ALICE_REGISTER_CODELET(isaac::alice::TcpSubscriber)
